...
<div class="navbar">
    ...
    <a href="artistForAdmin.php">Home</a>
    <a href="#section1">Event</a>
    <a href="#section2">Music</a>
    <a href="#section3">Concert</a>
    <div class="dropdown">
     
      <button class="dropbtn">Updates<i class="fa fa-caret-down"></i>
      </button>
      <div class="dropdown-content">
        <a href="#eventUpdate">Event</a>
        <a href="AddMusicReleased.php">Music</a>
        <a href="formUDcon.php">Concert</a>
      </div>

    </div>
    <div class="dropdown">
    <button class="dropbtn">Admin<i class="fa fa-caret-down"></i>
      </button>
      <div class="dropdown-content">
        <a href="CreateUser.php">Create</a>
        <a href="alluser.php">Delete</a>
